...
final class PartnerControllerBidFulfillOperation: BidFulfillOperation {
    ...
    private func finishFulfillment(
        with result: Result<(winningBid: Bid, partnerAd: PartnerAd, adSize: ChartboostMediationBannerSize?), ChartboostMediationError>
    ) {
        // Complete
...
extension PartnerControllerBidFulfillOperation {
    ...
    private func isAdSizeOversized(adSize: ChartboostMediationBannerSize) -> Bool {
