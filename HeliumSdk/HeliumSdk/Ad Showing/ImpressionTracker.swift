...
/// - note: We don't have a single method because AdFormat is not Obj-C compatible, but we should change this once this protocol isn't
/// needed by Obj-C code anymore.
...
final class CurrentSessionImpressionTracker: ImpressionTracker, ImpressionCounter {
    @OptionalInjected(\.customTaskDispatcher, default: .serialBackgroundQueue(name: "impressionTracker")) private var taskDispatcher
