...
struct MediationAuctionsHTTPRequestFactory: AuctionsHTTPRequestFactory {
    ...
    private func makeBidRequest(request: AdLoadRequest, bidderInformation: BidderInformation) -> OpenRTB.BidRequest {
        OpenRTB.BidRequest(
    ...
    private func makeImpression(request: AdLoadRequest) -> OpenRTB.Impression {
    ...
    private func makeRegulations() -> OpenRTB.Regulations {
        let ext = OpenRTB.Regulations.Extension(
    ...
    private func makeUser(request: AdLoadRequest) -> OpenRTB.User {
        let impdepth: Int
    ...
    private func makeExtension(request: AdLoadRequest, bidderInformation: BidderInformation) -> OpenRTB.BidRequest.Extension {
