...
public protocol HeliumInterstitialAd {
    ...
    /// 
    /// When complete, the delegate method ``CHBHeliumInterstitialAdDelegate/heliumInterstitialAd(withPlacementName:requestIdentifier:winningBidInfo:didLoadWithError:)`` will
    /// be invoked.
    @objc(loadAd)
    func load()
    ...
    ///
    /// When complete, the delegate method ``CHBHeliumInterstitialAdDelegate/heliumInterstitialAd(withPlacementName:didShowWithError:)`` will
    /// be invoked.
