...
/// Provides the capability to generate errors suitable to be passed in completion handlers for `PartnerAdapter` operations.
/// All functionality is provided by default implementations.
public extension PartnerAdapter {
        
    /// Returns a Chartboost Mediation error suitable to be passed in completion handlers for PartnerAdapter operations.
