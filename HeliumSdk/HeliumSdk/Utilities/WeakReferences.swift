...
/// Unfortunately this requirement cannot be specified in the type definition, since `Value: AnyObject` would restrict `Value` to be a class type and not a protocol that requires conformant types to be classes, which is a common use case.
