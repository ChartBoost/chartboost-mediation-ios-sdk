...
extension AdLoadResult: AnyEquatable {
...
extension AdShowResult: AnyEquatable {
...
extension Bid: AnyEquatable {
    ...
    func isEqual(to other: AnyEquatable) -> Bool {
        ...
        && self.partnerIdentifier == other.partnerIdentifier
        && self.adm == other.adm
        ...
        && self.auctionIdentifier == other.auctionIdentifier
