...
class ChartboostMediationTestCase: XCTestCase {
    ...
    override func setUp() {
        // Replace the shared dependencies container, so when a Helium SDK class is created in order to test it all its @Injected properties are assigned to mock values.
