...
final class PixelByTimeVisibilityTracker: VisibilityTracker {
    ...
    private var firstVisibleTimestamp: TimeInterval?
    ...
    private func checkViewVisibility() {
        ...
        let isViewVisible = view.isVisible(
            minimumVisiblePoints: configuration.minimumVisiblePoints,
            maximumDepth: configuration.traversalLimit
        )
    ...
    private func notifyCompletion() {
        ...
        // fire will be no-ops.
        guard let timer, case .active = timer.state else {
            return
        }
