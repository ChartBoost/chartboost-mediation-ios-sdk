...
struct RewardedCallbackHTTPRequest: HTTPRequestWithRawDataResponse {
    ...
    let shouldIncludeMediationHeaders = false
...
extension RewardedCallback {
    fileprivate func url(customData: String?, timestampMs: Int) -> URL? {
        ...
        urlString = urlString.replacingNetworkName(partnerID, uriEncode: true)
    ...
    fileprivate func bodyData(customData: String?, timestampMs: Int) -> Data? {
        ...
        bodyString = bodyString.replacingNetworkName(partnerID, uriEncode: false)
