...
extension ChartboostMediationError.Code {
    ...
    /// with the key `NSLocalizedFailureReasonErrorKey`.
    public var cause: String {
        ...
        case .loadFailureNoBannerView:
            return "The partner returns a banner ad with no view to show."
        ...
        case .preinitializationActionFailed:
            return "Requested action needs to be performed before initializing Chartboost Mediation."
        }
    }
}
