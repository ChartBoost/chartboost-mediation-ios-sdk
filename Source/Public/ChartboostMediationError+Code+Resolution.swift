...
extension ChartboostMediationError.Code {
    ...
    /// with the key `NSLocalizedRecoverySuggestionErrorKey`.
    public var resolution: String {
        ...
        case .prebidFailureUnsupportedAdFormat:
            return "This is an expected error when requesting an ad format not supported by all partners. If the ad format you are requesting for is supported by the partner, contact Chartboost Mediation Support and provide a copy of your console logs."
        ...
        case .preinitializationActionFailed:
            return "Perform the action before initializing Chartboost Mediation."
        }
    }
}
