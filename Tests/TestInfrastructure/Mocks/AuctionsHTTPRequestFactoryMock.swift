...
class AuctionsHTTPRequestFactoryMock: Mock<AuctionsHTTPRequestFactoryMock.Method>, AuctionsHTTPRequestFactory {
    ...
    func makeRequest(request: InternalAdLoadRequest, loadRateLimit: TimeInterval, bidderInformation: BidderInformation, completion: @escaping (AuctionsHTTPRequest) -> Void) {
