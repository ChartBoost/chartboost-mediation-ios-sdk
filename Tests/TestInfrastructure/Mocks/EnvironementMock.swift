...
extension EnvironmentMock {
    fileprivate final class AppInfoProviderMock: AppInfoProviding {
        var chartboostAppID: String? = "some-app-identifier"
        ...
        func randomizeAll() {
            chartboostAppID = Bool.random() ? String.random() : nil
    ...
    fileprivate final class AppTrackingInfoProviderMock: AppTrackingInfoProviding {
        ...
        func randomizeAll() {
            trackingAuthorizationStatus = .init(rawValue: UInt.random(in: 0...3)) ?? .notDetermined
