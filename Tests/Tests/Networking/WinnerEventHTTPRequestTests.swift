...
final class WinnerEventHTTPRequestTests: ChartboostMediationTestCase {
    ...
    private func customHeaders(format: AdFormat) -> [String: Any] {
        ["x-mediation-load-id": Self.loadID,
         "x-mediation-ad-type": format.rawValue]
    }
